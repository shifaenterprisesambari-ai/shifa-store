...
import { selectWishlistItems, selectWishlistLoading } from '../../store/wishlistSlice';
import ProductCard from '../../components/ProductCard';
import { EmptyState, Spinner } from '../../components/ui/Loaders';
    ...
    <div className="w-full max-w-7xl mx-auto px-2 sm:px-4 py-6">
      ...
      {items.length === 0 ? (
        <EmptyState
          ...
          action={
            <Link to="/" className="px-6 py-2.5 gradient-primary text-white rounded-xl font-medium">
              Browse Products
            </Link>
          }
        />
